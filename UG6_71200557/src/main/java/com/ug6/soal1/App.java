...
public class App {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (choice.equalsIgnoreCase("n")) {
            ...
            System.out.println("Please input with Y / N");
        }
    ...
    private static void checkSpecificationRequirement() {
        ...
        float productionRate;
            if (production.checkPhonesSpecification(phone.getAndroidCode(), phone.getRamCapacity(), phone.getRomCapacity())) {
            ...
            }else if (phone.getScreenSize() == 0.0F && phone.getRamCapacity() == 0 && phone.getRomCapacity() == 0 && phone.getCameraResolution() == 0) {
